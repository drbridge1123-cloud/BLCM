<?php
// GET /api/billing/list - All case_providers with latest request info
$userId = requireAuth();
...
if (!empty($_GET['status'])) {
    $allowed = ['not_started','requesting','follow_up','action_needed','received_partial','on_hold','received_complete','verified'];
