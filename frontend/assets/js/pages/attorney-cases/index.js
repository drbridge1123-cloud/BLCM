...
function attorneyCasesPage() {
    return {
        ...
        async loadStats() {
            try {
                const res = await api.get('attorney-cases/stats');
        ...
        async loadTab(tab, page = 1) {
            ...
            try {
                ...
                const res = await api.get('attorney-cases' + buildQueryString(params));
        ...
        async createCase() {
            ...
            this.saving = true;
            try {
                await api.post('attorney-cases', this.createForm);
        ...
        async updateCase() {
            this.saving = true;
            try {
                await api.put('attorney-cases/' + this.editForm.id, this.editForm);
        ...
        async deleteCase(id) {
            ...
            try {
                await api.delete('attorney-cases/' + id);
        ...
        async toggleDate(caseId, field, currentValue) {
            ...
            try {
                await api.post('attorney-cases/toggle-date', { case_id: caseId, field: field, date: date });
                await this.loadTab(this.activeTab);
            } catch (e) {
                showToast(e.data?.message || e.message || 'An error occurred', 'error');
            }
        ...
        async submitTopOffer() {
            ...
            this.saving = true;
            try {
                await api.post('attorney-cases/top-offer', this.topOfferForm);
        ...
        async settleDemand() {
            ...
            this.saving = true;
            try {
                const res = await api.post('attorney-cases/settle-demand', this.settleForm);
        ...
        async toLitigation() {
            this.saving = true;
            try {
                await api.post('attorney-cases/to-litigation', this.toLitForm);
        ...
        async toUim() {
            this.saving = true;
            try {
                await api.post('attorney-cases/to-uim', this.toUimForm);
        ...
        async settleLitigation() {
            ...
            this.saving = true;
            try {
                const res = await api.post('attorney-cases/settle-litigation', this.settleLitForm);
        ...
        async settleUim() {
            ...
            this.saving = true;
            try {
                const res = await api.post('attorney-cases/settle-uim', this.settleUimForm);
        ...
        async submitSendToAccounting() {
            ...
            try {
                ...
                const res = await api.post('attorney-cases/send-to-accounting', payload);
                if (res.success) {
