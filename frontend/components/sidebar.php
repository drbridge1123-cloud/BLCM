<aside class="sidebar fixed left-0 top-0 z-30 flex flex-col"
    ...
    <nav class="flex-1 overflow-y-auto">
        <div class="sb-nav">
            ...
            <a href="/blcm/frontend/pages/dashboard/index.php" class="sb-item <?= ($currentPage ?? '') === 'dashboard' ? 'active' : '' ?>">
            ...
            <a href="/blcm/frontend/pages/providers/index.php" class="sb-item <?= in_array(($currentPage ?? ''), ['providers','templates']) ? 'active' : '' ?>">
            ...
            <a href="/blcm/frontend/pages/messages/index.php" class="sb-item <?= ($currentPage ?? '') === 'messages' ? 'active' : '' ?>" x-data>
            ...
            <template x-if="$store.auth.hasPermission('cases')">
                <a href="/blcm/frontend/pages/bl-cases/index.php" class="sb-item <?= ($currentPage ?? '') === 'cases' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('traffic')">
                <a href="/blcm/frontend/pages/traffic/index.php" class="sb-item <?= ($currentPage ?? '') === 'traffic' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('referrals')">
                <a href="/blcm/frontend/pages/referrals/index.php" class="sb-item <?= ($currentPage ?? '') === 'referrals' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('prelitigation_tracker')">
                <a href="/blcm/frontend/pages/prelitigation/index.php" class="sb-item <?= ($currentPage ?? '') === 'prelitigation_tracker' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('mr_tracker')">
                <a href="/blcm/frontend/pages/billing/index.php" class="sb-item <?= ($currentPage ?? '') === 'mr_tracker' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('attorney_cases')">
                <a href="/blcm/frontend/pages/attorney/index.php" class="sb-item <?= ($currentPage ?? '') === 'attorney_cases' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('accounting_tracker')">
                <a href="/blcm/frontend/pages/accounting/index.php" class="sb-item <?= in_array(($currentPage ?? ''), ['accounting_tracker','bank_reconciliation','expense_report']) ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('commissions')">
                <a href="/blcm/frontend/pages/commissions/index.php" class="sb-item <?= ($currentPage ?? '') === 'commissions' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('reports')">
                <a href="/blcm/frontend/pages/reports/index.php" class="sb-item <?= ($currentPage ?? '') === 'reports' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('goals')">
                <a href="/blcm/frontend/pages/reports/goals.php" class="sb-item <?= ($currentPage ?? '') === 'goals' ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('users')">
                <a href="/blcm/frontend/pages/admin/users.php" class="sb-item <?= in_array(($currentPage ?? ''), ['users','data_management']) ? 'active' : '' ?>">
            ...
            <template x-if="$store.auth.hasPermission('activity_log')">
                <a href="/blcm/frontend/pages/admin/activity-log.php" class="sb-item <?= ($currentPage ?? '') === 'activity_log' ? 'active' : '' ?>">
                    <svg class="sb-icon" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
