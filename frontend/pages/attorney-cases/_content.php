...
<div x-data="attorneyCasesPage()">
    ...
    <div class="sp-card">
        ...
        <div class="sp-header" x-show="activeTab === 'demand'">
            ...
            <div class="sp-stats">
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#1a2535" x-text="stats.demand_count || 0"></div>
        ...
        <div class="sp-header" x-show="activeTab === 'uim'">
            ...
            <div class="sp-stats">
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#1a2535" x-text="stats.total_active || 0"></div>
                    <div class="sp-stat-label">Total</div>
                </div>
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#C9A84C" x-text="stats.uim_count || 0"></div>
                    <div class="sp-stat-label">UIM Active</div>
                </div>
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#2563eb" x-text="stats.litigation_count || 0"></div>
                    <div class="sp-stat-label">Litigation</div>
                </div>
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#1a9e6a" x-text="stats.settled_count || 0"></div>
                    <div class="sp-stat-label">Settled</div>
                </div>
            </div>
        </div>
        ...
        <div class="sp-header" x-show="activeTab === 'litigation'">
            ...
            <div class="sp-stats">
                <div class="sp-stat">
                    <div class="sp-stat-num" style="color:#1a2535" x-text="stats.litigation_count || 0"></div>
                    <div class="sp-stat-label">Total</div>
                </div>
                <div class="sp-stat">
        ...
        <div class="sp-header" x-show="activeTab === 'settled'">
            ...
            <div class="sp-stats">
                <div class="sp-stat" style="min-width:110px">
                    <div class="sp-stat-num" style="color:#1a9e6a; font-size:20px" x-text="stats.settled_count || 0"></div>
                    <div class="sp-stat-label">Settled</div>
                </div>
                <div class="sp-stat" style="min-width:110px">
