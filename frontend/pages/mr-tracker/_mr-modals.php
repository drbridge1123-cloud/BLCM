        ...
        <div class="mrt-body">
            ...
            <div x-show="reqForm.request_method === 'email' || reqForm.request_method === 'fax'"
                ...
                <div x-show="showDocs" x-collapse>
                    ...
                    <div class="mt-2 text-[10px] text-v2-text-light">For PDF field overlay, use <a :href="'/CMC/frontend/pages/cases/detail.php?id=' + reqForm._caseId" class="text-gold underline" target="_blank">Case Detail</a> &rarr; Documents</div>
                </div>
            </div>
        </div>
