...
<script src="/CMC/frontend/assets/js/pages/cases/mbds-panel.js?v=<?= filemtime(__DIR__ . '/../../assets/js/pages/cases/mbds-panel.js') ?>"></script>
<script src="/CMC/frontend/assets/js/pages/cases/negotiate-panel.js?v=<?= filemtime(__DIR__ . '/../../assets/js/pages/cases/negotiate-panel.js') ?>"></script>
<script src="/CMC/frontend/assets/js/pages/cases/disbursement-panel.js?v=<?= filemtime(__DIR__ . '/../../assets/js/pages/cases/disbursement-panel.js') ?>"></script>
<script src="/CMC/frontend/assets/js/pages/cases/health-ledger-panel.js?v=<?= filemtime(__DIR__ . '/../../assets/js/pages/cases/health-ledger-panel.js') ?>"></script>
